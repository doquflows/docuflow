...
### Fixed
- The package README on npm stated the wrong licence — `@doquflow/cli` still described the project as MIT licensed. It now states the proprietary freeware terms.

...
Proprietary freeware — free to use, with no warranty and at your own risk. Redistribution, resale,
modification and rights in the source code are not granted. Versions published before 2026-08-27
remain under the MIT Licence. See [LICENSE](https://github.com/doquflows/docuflow/blob/main/LICENSE).
